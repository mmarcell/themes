...
<h1 class="page-title"><?php _e( 'Search Results for: ', 'Volume' ); ?><span><?php the_search_query(); ?></span></h1>
...
<h2 class="entry-title"><?php _e( 'Nothing Found', 'Volume' ) ?></h2>
<div class="entry-content">
<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'Volume' ); ?></p>
<?php get_search_form(); ?>                                            
</div><!-- .entry-content -->
</div>
