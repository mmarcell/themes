...
<h1 class="page-title"><?php _e( 'Category Archives:', 'Volume' ) ?> <span><?php single_cat_title() ?></span></span></h1>
...
<span class="cat-links"><?php printf( __( 'Also posted in %s', 'Volume' ), $cats_meow ) ?></span>
<span class="meta-sep"> | </span>
<?php endif ?>
